...
public class CustomBlock extends CustomStack
{
     ...
     *
     * @param  itemStack
     *         The Bukkit ItemStack to get the CustomBlock instance from.
     * 
     * @return Possibly-null CustomBlock instance.
     */
    @Nullable
     ...
     *         Namespace and ID in the format {@code namespace:id}
     * @param  location
     *         The location to place the CustomBlock at.
     * 
     * @return Possibly-null CustomBlock instance.
     */
    @Nullable
     ...
     *
     * @param  location
     *         The location to remove the CustomBlock from.
     * 
     * @return True if the CustomBlock could be removed, otherwise false.
     */
     ...
     * 
     * @param  includeSelfBlock
     *         If the CustomBlock itself should be included in the list.
     * 
     ...
     * 
     * @param  tool
     *         The Item required to get the loot for the CustomBlock.
     * @param  includeSelfBlock
     *         If the CustomBlock itself should be included in the list.
     *
     * @return List containing ItemStack instances for the loot.
